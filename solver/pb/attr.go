...
const AttrGitExtraHosts = "git.extrahosts"
const AttrGitSearchDomains = "git.searchdomains"
...
const AttrHTTPExtraHosts = "http.extrahosts"
const AttrHTTPSearchDomains = "http.searchdomains"
